...
> Design notes for **course-follow-up-delay** — a runnable typescript example that Schedule a course marketplace follow-up webhook for a learner's next study window.
...
- **Feature code** — the actual task: course-follow-up.
